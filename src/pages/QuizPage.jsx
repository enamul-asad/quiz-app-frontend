...
import { FaClock, FaCheckCircle, FaExclamationTriangle, FaArrowRight, FaListAlt, FaRedo, FaShieldAlt } from 'react-icons/fa';
                ...
                <div className="lg:col-span-3">
                    ...
                    <div className="mt-6 flex justify-between">
                        ...
                        {currentQuestionIndex === quizData.questions.length - 1 ? (
                            <button onClick={handleSubmitQuiz} className="px-6 py-2 rounded-lg bg-green-600 text-white hover:bg-green-700 transition shadow-lg shadow-green-500/30">Submit Quiz</button>
                        ) : (
